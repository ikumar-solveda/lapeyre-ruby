...
export const getClient = (pub: boolean, baseUrl: string, traceDetails?: Record<string, string>) => {
...
export const getBaseOrMockURL = (baseUrl: string) => \`\${process.env.USE_MOCK === 'true' ? mockURL : baseUrl}${configuration.apiConfig.baseUrl}\`;
`;
