...
const ORDER_BY = {
	orderId: (desc: boolean) => (desc ? 'D-entityId' : 'A-entityId'),
...
export const useAdmin_OrderApprovalsManagementTable = () => {
		...
		[
			{
				...
				pageSize,
				q: 'orderApprovals' as unknown as AdminApprovalsManagementQueryParam['q'],
				approverId,
				...searchParam,
				params,
			},
			DATA_KEY_ORDER_APPROVALS_MANAGEMENT,
		],
