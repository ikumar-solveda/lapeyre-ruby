...
export const getGTMProductClickEventData = async (payload: GTMProductClickPayload) => {
	const { product, listerFlag, storeName, listId, listName, pageNumber } = payload;
	...
	return { products, currencyCode: currency, marketplaceStore, listId, listName, pageNumber };
};
