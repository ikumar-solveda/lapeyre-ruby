...
export const DATA_KEY_WISH_LIST_DETAILS = 'WISH_LIST_DETAILS';
...
export const DATA_KEY_PRODUCTS_BY_PART_NUMBERS = 'PRODUCTS_BY_PART_NUMBERS';
...
export const DATA_KEY_COUPONS = 'COUPONS';
...
export const DATA_KEY_CONFIGURATIONS = 'CONFIGURATIONS';
export const DATA_KEY_CURRENCY_FORMAT = 'CURRENCY_FORMAT';
export const DATA_KEY_ALLOWABLE_SHIPPING_MODES = 'ALLOWABLE_SHIPPING_MODES';
export const DATA_KEY_PRICE = 'PRICE';
export const DATA_KEY_ISSUED_COUPON = 'ISSUED_COUPONS';
export const DATA_KEY_APPLIED_COUPON = 'APPLIED_COUPONS';
export const DATA_KEY_QUOTES = 'QUOTES';
export const DATA_KEY_QUOTE_BY_ID = 'QUOTE_BY_ID';
export const DATA_KEY_QUOTE_COMMENTS = 'QUOTE_COMMENTS';
