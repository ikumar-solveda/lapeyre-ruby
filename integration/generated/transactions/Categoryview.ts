...
export class Categoryview<SecurityDataType = unknown> {
	...
	categoryviewByIdDetail = (
		...
		if (!this.traceDetails || this.traceDetails.includes('categoryviewByIdDetail')) {
	...
	categoryviewTopDetail = (
		...
		if (!this.traceDetails || this.traceDetails.includes('categoryviewTopDetail')) {
			const paramsLogger = logger.child({
				params,
				query: query ?? {},
				body: null ?? {},
	...
	categoryviewByParentCategoryDetail = (
		...
		if (!this.traceDetails || this.traceDetails.includes('categoryviewByParentCategoryDetail')) {
			const paramsLogger = logger.child({
				params,
				query: query ?? {},
				body: null ?? {},
