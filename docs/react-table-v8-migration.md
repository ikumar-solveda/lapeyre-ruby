# `react-table` migration from v7 to v8

This guide below is copied from [TanStack/table](https://github.com/TanStack/table/blob/main/docs/guide/migrating.md) with some additional information regarding pagination.
