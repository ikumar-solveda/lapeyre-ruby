...
describe(Switch, () => {
	it('should throw provided error', () =>
		expect(() => Switch('hello').orThrow(() => new Error('No match'))).toThrowError('No match'));

	it('should throw default error', () =>
		expect(() => Switch('hello').orThrow()).toThrowError(`'hello' out of range`));

	it('should return default value', () =>
		expect(Switch('hello').defaultTo(() => 'world')).toBe('world'));
