...
import { adminBuyerApprovalManagementStatusCircleSX } from '@/components/content/AdminBuyerApprovalsManagement/styles/statusCircle';
import {
...
export const AdminBuyerApprovalsManagementTableStatusCell: FC<
	...
	return (
		<TableCellResponsiveContent label={column.columnDef.header as string}>
			<Stack direction="row" spacing={1} justifyContent="flex-start">
				<Circle fontSize="small" sx={adminBuyerApprovalManagementStatusCircleSX(status)} />
				<Typography>
